...
import org.lebastudios.theroundtableplugins.cr.entities.Category;
import org.lebastudios.theroundtableplugins.cr.entities.Product;
import org.lebastudios.theroundtableplugins.cr.entities.SubCategory;
            ...
            if (taxesList.isEmpty())
            {
                TheRoundTableApplication.executeInFxThreadAndWait(() ->
                {
                    new RequestConfigStageController(new TaxesTypesConfigPaneController())
                            ...
                            .setTitle(Translator.getInstance().t("cr:reqconfig.notaxtypes"))
                            .instantiate(true);
                });
