...
import org.lebastudios.theroundtableplugins.cr.forms.TaxTypeFormPaneController;
...
public class TaxesTypesConfigPaneController extends ConfigPaneController<NoConfigFile>
{
    ...
    {
        super(new NoConfigFile(), Translator.getInstance().t("cr:phrase.taxestypes"), "cr:taxes.png");
    }
